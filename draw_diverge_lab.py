...
if __name__ == '__main__':
    ...
    Step = 5
    C = 6
    #divide_channel = [9.0, 15.0, 22.0, 27.0, 34.0, 41.0]
    #divide_slot = [23.0, 36.0, 49.0, 65.0, 81.0, 98.0]
    divide_channel = [10.0, 17.0, 26.0, 34.0, 44.0, 50.0]
    divide_slot = [23.0, 36.0, 49.0, 68.0, 81.0, 97.0]
    mdcg = [8.0, 14.0, 17.0, 22.0, 27.0, 34.0]
    ...
    plt.ylabel('length of superframe (time-slot)')
    plt.savefig('D:\\论文资料\\网络共存论文资料\\新的实验结果\\20240221\\diverge-delay.png', dpi=300, bbox_inches='tight')
    plt.show()
    hop_list = []
    for i in range(6):
        temp_path = [[],[],[]]
    ...
    plt.savefig('D:\\论文资料\\网络共存论文资料\\新的实验结果\\20240221\\channel-resource.png', dpi=300, bbox_inches='tight')
    plt.show()