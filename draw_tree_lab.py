...
if __name__ == '__main__':
    ...
    Step = 5
    C = 6
    divide_channel = [13.0, 23.0, 32.0, 40.0, 52.0, 61.0]
    divide_slot = [19.0, 33.0, 49.0, 66.0, 79.0, 96.0]
    mdcg = [8.0, 13.0, 19.0, 23.0, 29.0, 35.0]
    ...
    plt.savefig('D:\\论文资料\\网络共存论文资料\\新的实验结果\\20240221\\tree-delay.png', dpi=300,
                bbox_inches='tight')
    plt.show()
    hop_list = []
    for i in range(6):
    ...
    plt.savefig('D:\\论文资料\\网络共存论文资料\\新的实验结果\\20240221\\tree-resource.png', dpi=300,
                bbox_inches='tight')
    plt.show()
